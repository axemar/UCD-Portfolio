...
1. [Lab1](https://github.com/axemar/UCD-Portfolio/tree/main/ComputerVisionAndImaging) : Development of a mini ‘Vision Pipeline’: an Instagram-style image filter that applies a vintage sepia tone with vignetting, as well as a ‘Cool Blue Film’ style. This filter combines color shift, brightness adjustment, and a soft Gaussian blur, demonstrating how chaining multiple simple manipulations can create a visually appealing style.


1. [Lab1](https://github.com/axemar/UCD-Portfolio/tree/main/ComputerVisionAndImaging) : Development of a mini **Vision Pipeline** : an Instagram-style image filter that applies a vintage sepia tone with vignetting.
